...
Kubernetes secret, created by Terraform):

| Env var | Value |
|---|---|
| `SQL_SERVER_FQDN` | Azure SQL server FQDN |
| `SQL_BOT_USER` | `clawmockbot` (contained db user, db_owner in both DBs) |
| `SQL_BOT_PASSWORD` | generated by Terraform |
...
**Never print `SQL_BOT_PASSWORD` into a chat reply or a log you quote.**
